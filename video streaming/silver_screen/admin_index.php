...
// Secure query to fetch admin details
        ...
        if ($_FILES['movie']['size'] <= $maxFileSize) {
            ...
            if (in_array($_FILES['movie']['type'], $video_types)) {
                ...
                if (move_uploaded_file($_FILES['movie']['tmp_name'], 'movie/' . $movieName)) {
                    ...
                    $registerQuery->bind_param("ssssssss", $_POST["name"], $movieName, $thumbnail, $_POST["description"], $_POST["genre"], $_POST["subscription"], $_POST["date"], $_POST["language"]);
